                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content" >
                                    <div id="atScene" class="tab-pane active"> 
                                        ...
                                        <div class="offset5">
                                            <input   class="btn btn-primary" name="BodyFileNext" id="BodyFileNext" type="button" value="Next" /> 
                                            <%--Display save result --%> 
                                        </div>
                                    </div>
                                    ...
                                    <div id="atMortuary" class="tab-pane ">
                                        ...
                                        <fieldset class="fieldset">     
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="BMaddress" id="BMaddress"/> 
                                                </div>
                                            </div>
                                        ...
                                        <div class="offset5">
                                            <input type="submit"  class="btn btn-primary"   type="button" value="Add Body File" /> 
                                            <%--Display save result --%> 
                                        </div>
                                    </div>   
