...
public class Employee 
{
     ...
     * @param active determines whether a employee was is inactive or not
     */
    public Employee(String personnelNumber,String password,String name,String surname,String rank,int access,String email,boolean active)
    {
    ...
    /**
     * 
     * @return true-employee active or false-employee inactive
     */
    ...
    /**
     * 
     * @param active is true(active) or false(inactive)
     */
